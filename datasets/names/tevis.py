...
class Tevis(Dataset):
    def __init__(self, cfg):
        ...
        # filesystem
        self.anno_path = f"metadata/{self.mode}.zh.json"
    ...
    def get_item(self, index):
        ...
        # shot:
        shots_embedding = self.clip.encode_image(shot_path_list, pre_load=True) # B,1,K
        
        # text:
        text_embedding = self.clip.encode_text(text_list=chinese_text, return_seq=True) # 1,K (should be X,K if return_seq=True)
